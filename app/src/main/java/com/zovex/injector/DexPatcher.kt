...
class DexPatcher {
    ...
    private fun toImmutable(cls: ClassDef): ImmutableClassDef {
        ...
        return ImmutableClassDef(
            ...
            allFields,
            cls.methods?.map { toImmutableMethod(it) } ?: emptyList()
        )
    }
    ...
    private fun patchOnCreate(
        ...
        // בנה instructions ל-dialog ללא if-nez (פשוט יותר, עובד תמיד)
    ...
    // ── Build dialog instructions — ללא labels, ללא branches ──
